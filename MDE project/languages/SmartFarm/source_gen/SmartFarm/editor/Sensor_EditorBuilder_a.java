...
/*package*/ class Sensor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.Sensortype$Dra6;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no Sensortype>");
      editorCell.setCellId("property_Sensortype");
  ...
  private static final class PROPS {
    /*package*/ static final SProperty Sensortype$Dra6 = MetaAdapterFactory.getProperty(0x835d7f18a2604c9dL, 0xa7a7f5480713c93dL, 0x4868eb0de61c82e0L, 0x4868eb0de61c82e1L, "Sensortype");
  }
