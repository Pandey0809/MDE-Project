...
public class Camera_TextGen extends TextGenDescriptorBase {
  @Override
  public void generateText(final TextGenContext ctx) {
    final TextGenSupport tgs = new TextGenSupport(ctx);
    tgs.append("No. of Camera required");
    tgs.append(" " + SPropertyOperations.getInteger(ctx.getPrimaryInput(), PROPS.camerareq$2Hin));
  }
