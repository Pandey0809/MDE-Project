...
<model ref="r:29dde0db-af6f-4eda-bc9a-c207a3a34df9(SmartFarm.feedback)">
  ...
  <node concept="3QByoM" id="4xCUKRA9v7o">
    <ref role="3Z9TSV" to="hp5j:4xCUKRA7mF7" resolve="Drone" />
    <node concept="3QByp$" id="4xCUKRA9v7p" role="3QBEN7">
      <node concept="1GjwBS" id="4xCUKRA9v6H" role="3JXyrO">
        <ref role="sa$J1" to="fudv:1mFJTG7e$j" />
        <ref role="1Gj$d9" to="hp5j:4xCUKRA7mF8" resolve="reqnumber" />
      </node>
      <node concept="16I2mz" id="4xCUKRA9v7t" role="16N$OO">
        <node concept="16N$OT" id="4xCUKRA9v7y" role="16I2mt">
          <property role="16N$OU" value="No. of drone should be more than 0" />
        </node>
      </node>
    </node>
  </node>
  <node concept="3QByoM" id="4xCUKRA9Lgu">
    <ref role="3Z9TSV" to="hp5j:4xCUKRA7mFa" resolve="Camera" />
    <node concept="3QByp$" id="4xCUKRA9Lgv" role="3QBEN7">
      <node concept="1GjwBS" id="4xCUKRA9LfD" role="3JXyrO">
        <ref role="sa$J1" to="fudv:1mFJTG7e$j" />
        <ref role="1Gj$d9" to="hp5j:4xCUKRA9IOl" resolve="camerareq" />
      </node>
